...
public class JWTUtils {
     ...
     * @param token
     */
    public static String validateToken(String token) throws BusinessException {
        try {
     ...
     * @return
     */
    public static boolean isNeedUpdate(String token) throws BusinessException {
        //获取token过期时间
        Date expiresAt = null;
        try {
            ...
            throw new BusinessException(EmBusinessError.TOKEN_CHECK_ERROR);
        }
